...
class Seq2SeqTrainingArguments(TrainingArguments):
    ...
    max_position_embeddings: Optional[int] = field(default=1024, metadata={"help": "The maximum sequence length that this model might ever be used with. Typically set this to something large just in case (e.g., 512 or 1024 or 2048"})
...
def main():
    ...
    extra_model_params = ("encoder_layerdrop", "decoder_layerdrop", "dropout", "attention_dropout", "max_position_embeddings")
    ...
    special_tokens = ["$SEPB$", "$SEP$"] # special tokens for CiteExplainer 
    ...
    dataset_class = LegacySeq2SeqDataset
